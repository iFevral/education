namespace Store.BusinessLogic.Common.Constants
{
    public static partial class Constants
    {
        public class Errors
        {
            ...
            public const string NotFoundAuthorsError = "Authors haven`t found.";
            ...
            public const string NotFoundOrdersError = "Orders haven`t found.";

            public const string CreatePrintingEditionError = "Creating printing Edition has failed.";
            public const string UpdatePrintingEditionError = "Updating printing Edition has failed.";
            public const string DeletePrintingEditionError = "Deleting printing Edition has failed.";
            public const string NotFoundPrintingEditionError = "Printing edition hasn`t found.";
            public const string NotFoundPrintingEditionsError = "Printing editions haven`t found.";
        }
    }
}
